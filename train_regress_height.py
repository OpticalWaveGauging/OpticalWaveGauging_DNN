...
for batch_size in [16,32,64,128]: 
    ...
    for arch in archs:
	    ...
	    weight_path="im"+str(IMG_SIZE[0])+"_waveheight_weights_model"+str(counter)+"_"+str(num_epochs)+"epoch_"+str(train_gen.batch_size)+"batch.best.hdf5" 
